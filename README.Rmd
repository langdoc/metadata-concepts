...
So very central idea here is that whether same data is represented in CMDI XML, mysql database or graph database is irrelevant, as there should be a seamless connection between these. What we need is the ability to access values themselves, and for this it not be that important where they are stored.
